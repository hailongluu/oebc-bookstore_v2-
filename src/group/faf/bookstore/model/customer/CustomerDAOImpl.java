...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public void addCustomer(Customer customer) {
        try {
            String sqlAdd = "INSERT INTO address (`Street`, `WardId`) VALUES (?, '1');\n";
            String sqlName = "INSERT INTO fullname (`FirstName`, `LastName`) VALUES (?, ?);\n";
            String sqlAcc = "INSERT INTO account (`Username`, `Password`) VALUES (?, ?);\n";
            String sqlCus = "INSERT INTO customer(`AddressId`, `FullNameId`, `AccountId`) VALUES (?, ?, ?);\n";
            ...
            preName.setString(2, customer.getFullName().getLastName());
